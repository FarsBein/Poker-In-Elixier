...
perms = [ [ 9,  8,  7,  6,  5,  4,  3,  2,  1  ],  # 1   2-6 Straight flush VS 1-5 straight flush
          ...
          [ 6,  15, 45, 28,  2, 19, 32, 29, 41 ],  # 11  4-sixes VS 4-twos
          [ 1,  52, 44, 21, 39, 14, 36, 10, 23 ],  # 12  Both Full House with 2-A VS 2-K
          [ 6,  13,  1,  7,  2,  3,  8, 10, 11 ],  # 13  Both Flush with A high VS K high
          [ 11, 10,  9,  7,  2,  6,  8, 13,  3 ],  # 14  Both Flush with 10 high VS 11 high
          [ 13, 38,  3, 28,  1, 23, 47,  6, 18 ],  # 15  Highest card in player hand 13
          ...
          [ 52, 30, 39, 17, 25, 12, 51, 41, 44 ],  # 19  Both FH with one 4 high and another K high in the pair part
        ]
...
sols  = [ [ "2C",  "3C",  "4C",  "5C",  "6C"  ],   # 1   2-6 Straight flush
          ...
          [ "13C"                             ],   # 15  13 high
          [ "1D",  "13D", "12H", "11H", "10H" ],   # 16  Royal flush (not)
